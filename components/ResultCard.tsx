...
export const ResultCard: React.FC<ResultCardProps> = ({ data, onSearch, isFavorite, onToggleFavorite, settings }) => {
  ...
  return (
    <div className="w-full bg-white/70 dark:bg-slate-900/60 backdrop-blur-2xl rounded-3xl shadow-xl shadow-black/5 dark:shadow-black/20 border border-white/20 dark:border-white/5 overflow-hidden animate-zoom-in">
      {/* Header - Compact */}
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`p-2.5 rounded-full transition-all duration-300 shadow-md hover:scale-105 border ${isFavorite
      ...
      <div className="p-6 space-y-6">
        {data.meanings.map((meaning, index) => (
          <div
            key={index}
            className="flex gap-4 group opacity-0 animate-fade-in-up"
              ...
              <div className="mt-2 pl-3 border-l-2 border-[var(--p-accent)]/30">
                <div className="flex items-start gap-2.5">
                  ...
                  <button
                    ...
                    className={`mt-0.5 p-1 rounded-full hover:bg-[rgba(var(--p-accent-rgb),0.1)] transition-colors flex-shrink-0 ${activeExampleIndex === index ? 'text-[var(--p-accent)]' : 'text-slate-400 dark:text-slate-500'
                      }`}
        ...
        {settings.showIdioms && data.idioms_slang && data.idioms_slang.length > 0 && (
          <div
            className="p-4 mt-6 rounded-xl bg-orange-50/50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-500/20 relative overflow-hidden shadow-sm opacity-0 animate-fade-in-up"
        ...
        {settings.showMorphology && hasWordFamily && (
          <div
            className="pt-6 border-t border-slate-100 dark:border-white/5 opacity-0 animate-slide-in-right"
